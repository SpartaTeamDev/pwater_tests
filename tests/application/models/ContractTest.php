...
EOF
        ...
        $sql .= $this->transformDate('order_detail.instruction_plan_date', ['from' => $from, 'to' => $to]);
...
EOF
    ...
    /**
     * [11318][12119][12121][CRE] - [tuan_dung] - [23/06/2016] - Cron - CS06_05 Request cancel - refunded and re-
     * request purchase - UT Test
     *
